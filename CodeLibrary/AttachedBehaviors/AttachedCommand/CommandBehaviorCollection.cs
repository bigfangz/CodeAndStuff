...
namespace ZacksSampleCode.AttachedBehaviors.AttachedCommand
{
    using System;
    ...
    public class CommandBehaviorCollection
    {
        ...
        private static readonly DependencyPropertyKey BehaviorsPropertyKey
            = DependencyProperty.RegisterAttachedReadOnly("BehaviorsInternal",
                typeof(BehaviorBindingCollection),
